...
import { formConfig } from "./formConfigMP";
import Card from "react-credit-cards";
import "react-credit-cards/es/styles-compiled.css";
import useMercadoPago from "../mercadopago/hooks/useMercadoPago";
...
export default function MercadoPagoForm() {
    ...
    useEffect(() => {
        if (MercadoPago) {
            const mp = new MercadoPago(process.env.VITE_PUBLIC_KEY_MP);
            const cardForm = mp.cardForm({
                ...
                callbacks: {
                    ...
                    onSubmit: (event) => {
                        ...
                        fetch(
                            `${
                                process.env.VITE_URL_PAYMENT_MP
                            }/process-payment`,
                            {
                                // entry point backend
                                method: "POST",
